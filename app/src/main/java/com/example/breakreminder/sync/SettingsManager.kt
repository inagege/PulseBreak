...
object SettingsManager: ISettingsManager {
        ...
        GlobalScope.launch {
            try {
                ...
                if (nodes.isNotEmpty()) {
                    ...
                    Log.w("SettingsManager", "No wearable node connected.")
                }
            } catch (e: Exception) {
                Log.e("SettingsManager", "Failed to check for wearable connection.", e)
            }
        }
    }
